...
const ConfirmOrderView = ({
  address, cartItems, error, isLoading, order, orderNumber,
  paymentName, selectedPaymentMethod, shipping, onNavigate, totalItems, coupon, discountAmount,
