...
export const WarrantyPage = () => (
  <PageShell>
    ...
    <div className="mx-auto grid max-w-4xl gap-6 md:grid-cols-2"><Card icon={ShieldCheck} title="Solicitar garantía"><p>Solicita una garantía directamente desde el historial de tu compra:</p><ol className="mt-4 list-decimal space-y-2 pl-5 text-sm font-medium leading-6 text-slate-600"><li>Entra a <Link to="/perfil/compras" className="font-black text-emerald-600 hover:text-emerald-700">Mis compras</Link>.</li><li>Busca una orden marcada como <strong>Entregado</strong> y abre <strong>Acciones</strong>.</li><li>Selecciona <strong>Solicitar Garantía (RMA)</strong> y completa el formulario con los detalles del problema.</li><li>Adjunta fotografías o videos si son necesarios y envía el reporte.</li><li>Consulta el folio y el estado de tu garantía desde la misma orden.</li></ol></Card><Card icon={Headphones} title="¿Necesitas ayuda?"><p>Si tienes dudas sobre el proceso, escríbenos desde nuestro centro de soporte para recibir atención sobre pedidos, productos, garantías o devoluciones.</p><Link to="/soporte" className="mt-4 inline-block font-black text-emerald-600 hover:text-emerald-700">Ir a soporte →</Link></Card></div>
  </PageShell>
);
...
export const TermsPage = () => (
  <PageShell>
    <Intro eyebrow="Información legal" title="Términos y condiciones de uso">Estas condiciones regulan el uso académico y demostrativo de FIRSTPC y sus herramientas de catálogo, configuración y checkout.</Intro>
    <div className="mx-auto max-w-4xl space-y-5">
      <LegalSection title="Aviso importante: proyecto académico"><p>FIRSTPC es un proyecto académico y demostrativo. Actualmente no realiza ventas reales, no procesa cargos reales, no envía productos y no constituye una tienda comercial operativa. Las funciones de catálogo, carrito, checkout, pedidos, pagos, envíos y garantías/RMA se presentan únicamente con fines de demostración.</p><p>No introduzcas datos bancarios, contraseñas financieras ni información personal sensible en una demostración. Si se habilitara la operación comercial, estos términos y las políticas correspondientes se actualizarían antes de ofrecer ventas al público.</p></LegalSection>
      <LegalSection title="1. Identificación y aceptación"><p>FIRSTPC es un proyecto académico de una plataforma para explorar componentes, equipos y servicios de computación. Al navegar o crear una cuenta aceptas estos términos y las políticas relacionadas que se muestran en el sitio.</p></LegalSection>
      <LegalSection title="2. Cuenta y uso del sitio"><p>La persona usuaria debe proporcionar información verdadera, mantener actualizados sus datos y proteger sus credenciales. La cuenta es personal y no debe utilizarse para actividades ilícitas, fraude, abuso de promociones, interferencia con el sitio o intento de acceso no autorizado.</p><p>FIRSTPC puede limitar o suspender una cuenta cuando existan indicios razonables de uso indebido, fraude o incumplimiento de estas condiciones.</p></LegalSection>
      <LegalSection title="3. Productos, imágenes, precios y disponibilidad"><p>Las imágenes de los productos se utilizan como referencia visual y provienen de materiales publicados por las marcas o de sus sitios oficiales. FIRSTPC no reclama la propiedad de las marcas, logotipos o imágenes de terceros; sus derechos corresponden a sus respectivos titulares.</p><p>Las especificaciones, colores y existencias pueden variar respecto a la presentación en pantalla. Los precios, carrito y checkout mostrados en este proyecto son demostrativos y no representan una oferta de venta real.</p></LegalSection>
      <LegalSection title="4. Pedidos, pagos y envíos"><p>Las pantallas de pedidos, pagos y envíos forman parte de la demostración académica. No se realizan cobros, autorizaciones de pago, envíos ni entregas reales a través de este proyecto.</p></LegalSection>
      <LegalSection title="5. Garantías, devoluciones y RMA"><p>Los reportes de garantía o devolución deben realizarse desde los canales indicados en el sitio, proporcionando el número de pedido y la información del producto. Cada caso se revisará conforme a la naturaleza del producto, sus condiciones de garantía y la legislación aplicable.</p><p>El folio RMA permite dar seguimiento a la solicitud; no constituye por sí mismo una aprobación. El resultado puede requerir revisión técnica, evidencias, envío del producto o información adicional.</p></LegalSection>
      <LegalSection title="6. Opiniones y contenido de usuarios"><p>Las opiniones deben ser auténticas, respetuosas y relacionadas con el producto comprado. No se permite publicar contenido ilegal, ofensivo, engañoso, publicitario no autorizado o que infrinja derechos de terceros. FIRSTPC podrá retirar contenido que incumpla estas reglas.</p></LegalSection>
      <LegalSection title="7. Materiales y contacto"><p>El nombre FIRSTPC, su identidad visual y el logotipo fueron creados para este proyecto académico con apoyo de herramientas de inteligencia artificial. Las imágenes de productos, marcas, logotipos y demás materiales de terceros pertenecen a sus respectivos propietarios; se muestran únicamente como referencia dentro de esta demostración y FIRSTPC no reclama su propiedad ni afiliación comercial.</p><p>Para dudas sobre estos términos escribe a <a href="mailto:contacto.firstpc@gmail.com" className="font-black text-emerald-600 hover:text-emerald-700">contacto.firstpc@gmail.com</a> o llama al <a href="tel:+529811852169" className="font-black text-emerald-600 hover:text-emerald-700">981 185 2169</a>.</p></LegalSection>
      <p className="text-center text-xs font-semibold text-slate-400">Última actualización: 5 de agosto de 2026.</p>
    </div>
  </PageShell>
);
...
export const PrivacyPage = () => (
  <PageShell>
    <Intro eyebrow="Información legal" title="Aviso de privacidad">En FIRSTPC cuidamos la información que compartes al crear tu cuenta, comprar o solicitar soporte.</Intro>
    <div className="mx-auto max-w-4xl space-y-5">
      <LegalSection title="Aviso importante: proyecto académico"><p>FIRSTPC es un proyecto académico y demostrativo, no una tienda comercial activa. No hay ventas, cobros, envíos ni entregas reales. La información registrada en la plataforma se utiliza para demostrar el funcionamiento de sus pantallas y herramientas.</p><p>No ingreses datos bancarios, contraseñas financieras ni información sensible que no sea necesaria para la demostración.</p></LegalSection>
      <LegalSection title="1. Responsable y contacto"><p>FIRSTPC es responsable del tratamiento de los datos personales recabados a través de FIRSTPC. Para dudas, solicitudes o ejercicio de derechos puedes escribir a <a href="mailto:contacto.firstpc@gmail.com" className="font-black text-emerald-600 hover:text-emerald-700">contacto.firstpc@gmail.com</a> o comunicarte al <a href="tel:+529811852169" className="font-black text-emerald-600 hover:text-emerald-700">981 185 2169</a>.</p></LegalSection>
      <LegalSection title="2. Datos que podemos recabar"><p>En la demostración podemos solicitar nombre, correo electrónico, teléfono, domicilio de entrega, datos de facturación, información de pedidos, productos adquiridos, solicitudes de garantía/RMA, opiniones y comunicaciones de soporte.</p><p>Este proyecto no necesita datos bancarios reales. No ingreses números de tarjeta, contraseñas bancarias ni códigos de seguridad.</p></LegalSection>
      <LegalSection title="3. Finalidades"><p>Usamos la información para demostrar la creación y administración de cuentas, el funcionamiento del catálogo, carrito, checkout, historial, opiniones verificadas, soporte y flujos de garantía/RMA. No usamos estos datos para realizar ventas, cargos o entregas reales.</p><p>Cuando corresponda, podremos usar tu correo para enviarte comunicaciones relacionadas con la demostración o tu cuenta.</p></LegalSection>
      <LegalSection title="4. Proveedores y transferencias"><p>Para operar la tienda podemos apoyarnos en servicios de autenticación y almacenamiento de información, procesadores de pago, paqueterías, proveedores tecnológicos y servicios de soporte. Solo compartimos los datos necesarios para cumplir la finalidad correspondiente y exigimos medidas razonables de protección.</p></LegalSection>
      <LegalSection title="5. Conservación y seguridad"><p>Conservamos la información durante el tiempo necesario para cumplir las finalidades descritas, atender responsabilidades legales y resolver aclaraciones. Aplicamos medidas administrativas, técnicas y físicas razonables; sin embargo, ningún sistema conectado a internet puede garantizar seguridad absoluta.</p></LegalSection>
      <LegalSection title="6. Derechos de la persona titular"><p>Puedes solicitar acceso, rectificación, cancelación u oposición al tratamiento de tus datos, así como retirar tu consentimiento cuando sea procedente. Envía tu solicitud a nuestro correo indicando tu nombre, medio de contacto, derecho que deseas ejercer y la información necesaria para localizar tus datos. Responderemos conforme a los plazos aplicables.</p></LegalSection>
      <LegalSection title="7. Cookies y cambios"><p>El sitio puede utilizar almacenamiento local y tecnologías similares para mantener la sesión, guardar preferencias y conservar elementos como el carrito o la configuración del PC Builder. Puedes administrar estas tecnologías desde tu navegador, aunque algunas funciones podrían dejar de operar correctamente.</p><p>Este aviso puede actualizarse para reflejar cambios en el servicio o en la normativa. Publicaremos la versión vigente en esta página.</p></LegalSection>
      <p className="text-center text-xs font-semibold text-slate-400">Última actualización: 5 de agosto de 2026.</p>
    </div>
  </PageShell>
);
