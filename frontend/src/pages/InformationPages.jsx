...
export const PrivacyPage = () => (
  <PageShell>
    ...
    <div className="mx-auto max-w-4xl space-y-5">
      ...
      <LegalSection title="2. Datos que podemos recabar"><p>En la demostración podemos solicitar nombre, correo electrónico, teléfono, domicilio de entrega, información de pedidos, productos adquiridos, solicitudes de garantía/RMA, opiniones y comunicaciones de soporte.</p><p>Este proyecto no procesa cargos reales. No ingreses números de tarjeta, contraseñas bancarias ni códigos de seguridad.</p></LegalSection>
